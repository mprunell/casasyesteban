...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Workshop.name'
        db.add_column(u'pages_workshop', 'name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=256),
                      keep_default=False)

        # Adding field 'Workshop.description'
        db.add_column(u'pages_workshop', 'description',
                      self.gf('django.db.models.fields.TextField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Workshop.name'
        db.delete_column(u'pages_workshop', 'name')

        # Deleting field 'Workshop.description'
        db.delete_column(u'pages_workshop', 'description')
